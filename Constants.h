 ...
 */
#define TOKEN_VENDING_MACHINE_URL    @"http://mytvm.elasticbeanstalk.com/"
...
#define DOMAIN_NAME_FOR_PLACES       @"budget-places"
#define HomeScreenDomainName         @"bb-launch"
#define HomeScreenItemName           @"NewEpisode"
#define GiveawayHeaderDomain         @"bb-giveawayHeader"
#define GiveawayGiftsDomain          @"bb-giveawayGifts"
#define GiveawayWinnersDomain        @"bb-giveawayWinners"
