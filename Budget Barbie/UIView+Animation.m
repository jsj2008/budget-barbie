...
- (void) moveTo:(CGPoint)destination duration:(float)secs delay:(float)secsDelayed option:(UIViewAnimationOptions)option 
{
    [UIView animateWithDuration:secs delay:secsDelayed options:option
                     animations:^{
