...
- (void)perform
{
  ...
  // Left door image
  self.doorLayerLeft.contents = (id)[CIDoorwaySegue clipImageFromLayer:[[self.sourceViewController view] layer] size:leftDoorRect.size offsetX:0.0f offsetY:0.0f];
  
  // Right door image
  self.doorLayerRight.contents = (id)[CIDoorwaySegue clipImageFromLayer:[[self.sourceViewController view] layer] size:rightDoorRect.size offsetX:-leftDoorRect.size.width offsetY:0.0f];
  
  // Next view image
  self.nextViewLayer.contents = (id)[CIDoorwaySegue clipImageFromLayer:[[self.destinationViewController view] layer] size:viewSize offsetX:0.0f offsetY:-20.0f];
...
- (CAAnimation *)zoomInAnimation
{
  ...
  zoomInAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionLinear];
...
- (CAAnimation *)openDoorAnimationWithRotationDegree:(CGFloat)degree
{
  ...
  openAnimimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionLinear];
